...
**(2)** **Shield** 는 AWS 웹 애플리케이션을 DDoS 공격으로부터 보호하는 서비스입니다.
...
**(3)** **Web Application Firewall(WAF)** 는 **HTTP(OSI 7 Layer) 수준에서 웹 애플리케이션을 보호하는 방화벽**입니다.
...
**(4)** **AWS Firewall Manager** 는 AWS Organizations 의 여러 계정과 애플리케이션의 방화벽 규칙을

...
1. [들어가며](#들어가며)
2. [서비스 인스턴스 구축하기](#서비스-인스턴스-구축하기)
3. [ELB 를 활용해 분산 트래픽 적용하기](#elb-를-활용해-분산-트래픽-적용하기)
4. [데이터베이스 구축하기](#데이터베이스-구축하기)
5. [추가 작업](#추가-작업)
...
서비스 인스턴스를 생성하기 위해
**<a href="{{ site.github.url }}/cloud/2021/09/18/build-cloud-infra-with-aws01#elastic-compute-cloud-ec2"
...
target="_blank">EBS</a>** 는 EC2 전용이지만 별도의 블록으로 생성되므로
...
**<a href="{{ site.github.url }}/cloud/2021/09/18/build-cloud-infra-with-aws01#4-optional-nat-게이트웨이-생성"
